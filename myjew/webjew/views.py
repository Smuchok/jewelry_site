    ...
    team = [
        {
            'name': 'Діана',
            'photo': 'Діана.jpg',
            'text': ['Студентка групи КН-51 Української академії друкарства', 'Дизайнер, контент мейкер, редактор, керівник проекту'],
       },
        {
            'name': 'Тарас',
            'photo': 'Тарас.jpg',
            ...
            'name': 'Олексій',
            'photo': 'Олексій.jpg',
            'text': ['Студент групи КН-52 Української академії друкарства', 'Редактор фото, редактор контенту, аналітик, помічник керівника'],
        },        {
            'name': 'Віталій',
            'photo': 'Віталій.jpg',
